...
The `repository.url` value in the `package.json` of a community package must be different from the default value `https://github.com/<...>/flowease-nodes-<...>.git` or a user-defined default.
