...
`description` in dynamic-options-type node parameter must be `Choose from the list, or specify an ID using an <a href="https://docs.flowease.io/code/expressions/">expression</a>`
...
const test = {
	...
	default: "",
	description:
		'This is a sentence. Choose from the list, or specify an ID using an <a href="https://docs.flowease.io/code/expressions/">expression</a>.',
};
```
