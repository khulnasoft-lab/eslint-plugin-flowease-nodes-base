...
function isStringField(
	...
	/**
	 * This plugin is on ESLint 8, but flowease-workflow is still at ESLint 7.32,
	 * which uses `ClassProperty` instead of `PropertyDefinition`. Hence these
	 * checks are generalized for now, until flowease-workflow upgrades its ESLint to 8.
	 */
	return (
		"key" in property &&
