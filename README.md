...
[![NPM version](https://img.shields.io/npm/v/eslint-plugin-flowease-nodes-base.svg?style=flat)](https://npmjs.org/package/eslint-plugin-flowease-nodes-base)
[![Tests](https://github.com/khulnasoft-lab/eslint-plugin-flowease-nodes-base/actions/workflows/on-push.yml/badge.svg)](https://github.com/khulnasoft-lab/eslint-plugin-flowease-nodes-base/actions)

ESLint plugin for linting flowease nodes.
...
```sh
pnpm i -D eslint-plugin-flowease-nodes-base
```
...
```js
{
  ...
  rules: {
    "flowease-nodes-base/node-param-array-type-assertion": "warning",
...
```js
{
  ...
  rules: {
    "flowease-nodes-base/node-param-array-type-assertion": "off",
    "flowease-nodes-base/node-param-default-wrong-for-collection": "off"
  }
}
```
...
| Config        | Content                                             |
| ------------- | --------------------------------------------------- |
| `nodes`       | Ruleset for flowease nodes                               |
| `credentials` | Ruleset for flowease credentials                         |
| `community`   | Ruleset for `package.json` in flowease community package |
...
```js
{
  ...
  extends: [ "plugin:flowease-nodes-base/nodes" ],
  rules: {
    "flowease-nodes-base/community-package-json-author-name-still-default": [
      "error",
...
| [community-package-json-flowease-api-version-missing](docs/rules/community-package-json-flowease-api-version-missing.md) | The `flowease.floweaseNodesApiVersion` key must be present in the `package.json` of a community package. | No |
| [community-package-json-flowease-api-version-not-number](docs/rules/community-package-json-flowease-api-version-not-number.md) | The `flowease.floweaseNodesApiVersion` value in the `package.json` of a community package must be a number. | No |
| [community-package-json-flowease-missing](docs/rules/community-package-json-flowease-missing.md) | The `flowease` key must be present in the `package.json` of a community package. | No |
| [community-package-json-flowease-nodes-empty](docs/rules/community-package-json-flowease-nodes-empty.md) | The `flowease.nodes` value in the `package.json` of a community package must contain at least one filepath. | No |
| [community-package-json-flowease-nodes-missing](docs/rules/community-package-json-flowease-nodes-missing.md) | The `flowease.nodes` key must be present in the `package.json` of a community package. | No |
...
| [community-package-json-keywords-without-official-tag](docs/rules/community-package-json-keywords-without-official-tag.md) | The `keywords` value in the `package.json` of a community package must be an array containing the value `'flowease-community-node-package'`. | No |
...
| [community-package-json-name-still-default](docs/rules/community-package-json-name-still-default.md) | The `name` key in the `package.json` of a community package must be different from the default value `flowease-nodes-<...>` or a user-defined default. | No |
| [community-package-json-repository-url-still-default](docs/rules/community-package-json-repository-url-still-default.md) | The `repository.url` value in the `package.json` of a community package must be different from the default value `https://github.com/<...>/flowease-nodes-<...>.git` or a user-defined default. | No |
...
| [cred-class-field-display-name-miscased](docs/rules/cred-class-field-display-name-miscased.md) | `displayName` field in credential class must be title cased, except for `flowease API` and `E-goi API` | Yes |
...
| [node-param-description-wrong-for-dynamic-multi-options](docs/rules/node-param-description-wrong-for-dynamic-multi-options.md) | `description` in dynamic-multi-options-type node parameter must be `Choose from the list, or specify IDs using an <a href="https://docs.flowease.io/code/expressions/">expression</a>` | Yes |
| [node-param-description-wrong-for-dynamic-options](docs/rules/node-param-description-wrong-for-dynamic-options.md) | `description` in dynamic-options-type node parameter must be `Choose from the list, or specify an ID using an <a href="https://docs.flowease.io/code/expressions/">expression</a>` | Yes |
